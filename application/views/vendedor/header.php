                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo base_url(); ?>Vendedor/CrearProducto">Crear Producto</a>
                                    <a class="nav-link" href="<?php echo base_url(); ?>Vendedor/Productos">Ver Producto</a>
                                </nav>
                            </div>
